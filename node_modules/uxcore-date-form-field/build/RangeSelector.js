...
var _uxcoreTag = require('uxcore-tag');

var _uxcoreTag2 = _interopRequireDefault(_uxcoreTag);
...
var RangeSelector = function (_React$Component) {
  ...
  RangeSelector.prototype.render = function render() {
    ...
    return dateRanges.length ? _react2["default"].createElement(
      _uxcoreTag2["default"],
      { addTags: false },
