...
<html lang="en">
<head>
    <title>Code coverage report for src/Tinymce.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Tinymce.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.03% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>103/117</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  Tinymce.prototype.componentWillMount = function componentWillMount() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_typeof(window.tinymce) !== 'object') {
<span class="cstat-no" title="statement not covered" >      console.warn('TinyMCE is not found in global, init failed');</span>
    }
...
&nbsp;
  Tinymce.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_util2['default'].isEqual(nextProps.config, this.props.config)) {
<span class="cstat-no" title="statement not covered" >      this.init(nextProps.config, nextProps.content);</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (nextProps.content !== this.props.content &amp;&amp; window.tinymce) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isInited) {
...
&nbsp;
  Tinymce.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    return !_util2['default'].isEqual(this.props.content, nextProps.content) || <span class="branch-1 cbranch-no" title="branch not covered" >!_util2['default'].isEqual(this.props.config, nextProps.config);</span>
  };
&nbsp;
  Tinymce.prototype.componentWillUnmount = <span class="fstat-no" title="function not covered" >function componentWillUnmount() {</span>
...
&nbsp;
  Tinymce.prototype.resetValue = function resetValue(value) {
    var me = this;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.setValueTimer) {
<span class="cstat-no" title="statement not covered" >      clearTimeout(this.setValueTimer);</span>
    }
    this.setValueTimer = setTimeout(function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (me.isInited) {
        me.setTinymceContent(value);
      } else {
<span class="cstat-no" title="statement not covered" >        me.contentToBeSet = value;</span>
      }
...
&nbsp;
  Tinymce.prototype.init = function init(config, content) {
    var me = this;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (me.isInited) {
<span class="cstat-no" title="statement not covered" >      me.remove();</span>
    }
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!trueConfig.language) {
    ...
    trueConfig.setup = function (editor) {
      ...
      editor.on('init', function () {
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (content) {
<span class="cstat-no" title="statement not covered" >          editor.setContent(content);</span>
        }
      });
    };
...
&nbsp;
  Tinymce.prototype.remove = <span class="fstat-no" title="function not covered" >function remove() {</span>
<span class="cstat-no" title="statement not covered" >    window.tinymce.EditorManager.execCommand('mceRemoveEditor', true, this.id);</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Jan 07 2018 20:12:29 GMT+0800 (CST)
</div>
</div>
