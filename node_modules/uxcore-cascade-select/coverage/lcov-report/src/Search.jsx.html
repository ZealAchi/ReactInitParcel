...
<html lang="en">
<head>
    <title>Code coverage report for src/Search.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Search.jsx
    </h1>
    <div class='clearfix'>
...
var Search = function Search(_ref) {
  ...
  return _react2['default'].createElement('input', {
    ...
    onChange: function onChange(e) {
      ...
      // 修复IE11下bug
      <span class="missing-if-branch" title="if path not taken" >I</span>if (value === null &amp;&amp; text === '' &amp;&amp; keywords === '') {
<span class="cstat-no" title="statement not covered" >        onValueChange(null);</span>
      } else {
...
Search.propTypes = {
  ...
  searchOption: _propTypes2['default'].object,
  onSearchResultChange: _propTypes2['default'].func,
      ...
      result.map(function (item) {
        return _react2['default'].createElement(
          'li',
          {
            ...
            onMouseEnter: <span class="fstat-no" title="function not covered" >function onMouseEnter(e) {</span>
<span class="cstat-no" title="statement not covered" >              e.target.className += ' kuma-select2-dropdown-menu-item-active';</span>
            },
            onMouseLeave: <span class="fstat-no" title="function not covered" >function onMouseLeave(e) {</span>
<span class="cstat-no" title="statement not covered" >              e.target.className = e.target.className.replace(' kuma-select2-dropdown-menu-item-active', '');</span>
            }
          },
          item.label
        );
