...
<html lang="en">
<head>
    <title>Code coverage report for src/CascadeSelect.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> CascadeSelect.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">83.58% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>341/408</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">74.18% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>204/275</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>330/371</span>
      </div>
    </div>
  </div>
...
919
920
921</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (onSelect &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!hasChildren </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >index + 1 &lt; cascadeSize)</span> {
...
<span class="cstat-no" title="statement not covered" >        _this.fetchOptions(newValue, key, index + 1);</span>
      } else {
        if (!hasChildren || index + 1 &gt;= cascadeSize) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (miniMode) {
            hideSubmenu = true;
            showSubMenu = false;
          }
        }
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (locale === 'zh_CN') {
<span class="cstat-no" title="statement not covered" >      _this.locale = 'zh-cn';</span>
...
<span class="cstat-no" title="statement not covered" >      options = [];</span>
    ...
    var newState = {};
    var judgeValue = (0, _util.stringify)(value) !== (0, _util.stringify)(preState.preValue);
    var judgeOptions = (0, _util.stringify)(options) !== (0, _util.stringify)(preState.preOptions);
    if (judgeOptions) {
      newState.options = options;
      newState.preOptions = options;
      newState.loadedOptions = {};
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (judgeValue) {
<span class="cstat-no" title="statement not covered" >      newState.value = value;</span>
<span class="cstat-no" title="statement not covered" >      newState.preValue = value;</span>
    }
    if (judgeValue || judgeOptions) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!onSelect) {
        var theOptions = preState.options;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (newState &amp;&amp; newState.options) {
          theOptions = newState.options;
        }
        var selectedOptions = CascadeSelect.getSelectedOptions(nextProps, { options: theOptions });
        var state = CascadeSelect.returnMultiState(selectedOptions) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
        <span class="missing-if-branch" title="else path not taken" >E</span>if (newState &amp;&amp; newState.options) {
          state.options = newState.options;
          state.loadedOptions = newState.loadedOptions;
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (newState &amp;&amp; newState.value) {
<span class="cstat-no" title="statement not covered" >          state.preValue = state.value;</span>
<span class="cstat-no" title="statement not covered" >          state.value = newState.value;</span>
<span class="cstat-no" title="statement not covered" >          state.displayValue = newState.value;</span>
        }
        newState = state;
      }
    }
...
&nbsp;
      var _loop = function _loop(i, l) {
        ...
        prevSelected = (0, _util.find)(renderArr, function (item) {
          return item.value === theValue[i];
        });
        <span class="missing-if-branch" title="else path not taken" >E</span>if (renderArr &amp;&amp; prevSelected) {
          selectedOptions[i] = prevSelected;
        } else {
<span class="cstat-no" title="statement not covered" >          selectedOptions = [];</span>
...
&nbsp;
      for (var i = 0, l = theValue.length; i &lt; l; i++) {
        var _ret = _loop(i, l);
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (_ret === 'break') <span class="cstat-no" title="statement not covered" >break;</span>
      }
    } else if (theValue &amp;&amp; theValue.length === 1) {
      selectedOptions = (0, _util.getArrayLeafItemContains)(options, theValue);
    }
...
&nbsp;
    var judgeValue = (0, _util.stringify)(value &amp;&amp; (0, _util.deepCopy)(value)) !== (0, _util.stringify)((0, _util.deepCopy)(this.props.value));
    var judgeOptions = (0, _util.stringify)(options) !== (0, _util.stringify)(this.props.options);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (onSelect &amp;&amp; (judgeValue || judgeOptions)) {
<span class="cstat-no" title="statement not covered" >      this.getAsyncSelectedOptions(this.props, <span class="fstat-no" title="function not covered" >function (selectedOptions) {</span></span>
<span class="cstat-no" title="statement not covered" >        _this2.setMultiState(selectedOptions);</span>
      });
    }
  };
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.state.loadedOptions[key]) {
<span class="cstat-no" title="statement not covered" >      return _lie2['default'].resolve('n');</span>
    }
    ...
    if (onSelect &amp;&amp; level &lt; cascadeSize) {
      return new _lie2['default'](function (resolve, reject) {
        ...
        values.forEach(function (value, index) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (index + 1 &gt; level) {
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
          node = (0, _util.find)(node, function (item) {
...
<span class="cstat-no" title="statement not covered" >        loading[key] = false;</span>
<span class="cstat-no" title="statement not covered" >        _this3.setState({ loading: loading });</span>
      });
    }
...
&nbsp;
  CascadeSelect.prototype.getAsyncSelectedOptions = function getAsyncSelectedOptions(props) {
    var _this5 = this;
&nbsp;
    var callback = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : <span class="branch-1 cbranch-no" title="branch not covered" >noop;</span>
&nbsp;
    var selectedOptions = [];
    var value = props.value,
        defaultValue = props.defaultValue,
...
&nbsp;
    var theValue = value || <span class="branch-1 cbranch-no" title="branch not covered" >defaultValue;</span>
    var renderArr = null;
    var prevSelected = null;
...
<span class="cstat-no" title="statement not covered" >        callback.call(_this5, selectedOptions);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      if (i === 0) {
        renderArr = options;
...
<span class="cstat-no" title="statement not covered" >        selectedOptions = [];</span>
<span class="cstat-no" title="statement not covered" >        callback.call(this, selectedOptions);</span>
      }
    }
    recursive();
  };
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (onChange) {
      if (isMustSelectLeaf) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (value &amp;&amp; (value.length &gt;= cascadeSize || <span class="branch-2 cbranch-no" title="branch not covered" >value.length === 0)</span> || <span class="branch-3 cbranch-no" title="branch not covered" >selectedOptions </span>&amp;&amp; (<span class="branch-4 cbranch-no" title="branch not covered" >selectedOptions[selectedOptions.length - 1] </span>&amp;&amp; <span class="branch-5 cbranch-no" title="branch not covered" >!selectedOptions[selectedOptions.length - 1].hasOwnProperty('children') </span>|| <span class="branch-6 cbranch-no" title="branch not covered" >selectedOptions.length === 0)</span>) {
...
&nbsp;
  CascadeSelect.prototype.onDropDownVisibleChange = <span class="fstat-no" title="function not covered" >function onDropDownVisibleChange(visible) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.setState({ showSubMenu: visible });</span>
    }
  };
&nbsp;
...
&nbsp;
  CascadeSelect.prototype.renderSelect2Options = function renderSelect2Options(opt) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.state.options) {
...
&nbsp;
    var _loop2 = function _loop2(i) {
      var opt = (0, _util.getOptions)(options, value, i);
      if (loading[value[i]]) {
        relLoading[i + 1] = true;
      }
...
<span class="cstat-no" title="statement not covered" >                  stateValue = [v];</span>
<span class="cstat-no" title="statement not covered" >                  selectedOptions = options.filter(<span class="fstat-no" title="function not covered" >function (item) {</span></span>
<span class="cstat-no" title="statement not covered" >                    return item.value + '_' === v + '_';</span>
                  });
                } else {
                  stateValue[i] = v;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!(selectedOptions[i].children &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >selectedOptions[i].children.length)</span>) {
...
&nbsp;
    return _Search2['default'].renderResult(this.state.searchResult, function (item) {
      ...
      var val = [];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (selectedOptions &amp;&amp; selectedOptions.length) {
...
&nbsp;
    var data = (0, _util.searchArrayOfOptions)({
      options: options,
      keywords: inputValue,
    ...
    if (displayMode === 'search' &amp;&amp; this.state.searchResult.length &gt; 0) {
      ...
      submenu = _react2['default'].createElement(_CascadeSubmenu2['default'], {
        ...
        onOkButtonClick: function onOkButtonClick() {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (_this10.props.isMustSelectLeaf) {
<span class="cstat-no" title="statement not covered" >            if (newValue &amp;&amp; newValue.length &lt; _this10.props.cascadeSize &amp;&amp; newSelectedOptions &amp;&amp; newSelectedOptions[newSelectedOptions.length - 1] &amp;&amp; newSelectedOptions[newSelectedOptions.length - 1].hasOwnProperty('children')) {</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
          }
          <span class="missing-if-branch" title="else path not taken" >E</span>if (newValue &amp;&amp; newSelectedOptions) {
            _this10.setState({
              value: newValue,
...
CascadeSelect.defaultProps = {
  ...
  beforeRender: function beforeRender(value, selectedOptions) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (selectedOptions.length) {
...
&nbsp;
CascadeSelect.CascadeSubmenu = <span class="fstat-no" title="function not covered" >function (_ref) {</span>
...
<span class="cstat-no" title="statement not covered" >  return _react2['default'].createElement(</span>
    ...
    _react2['default'].createElement(_CascadeSubmenu2['default'], _extends({
      ...
      onItemClick: <span class="fstat-no" title="function not covered" >function onItemClick(key, index) {</span>
...
<span class="cstat-no" title="statement not covered" >          value = value.slice(0, index);</span>
        }
<span class="cstat-no" title="statement not covered" >        value[index] = key;</span>
<span class="cstat-no" title="statement not covered" >        props.onChange(value);</span>
      }
    }))
  );
};
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Nov 08 2018 17:56:05 GMT+0800 (CST)
</div>
</div>
