...
<html lang="en">
<head>
    <title>Code coverage report for src/CascadeSubmenu.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> CascadeSubmenu.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.81% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>127/148</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">71.43% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>75/105</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    ...
    this.timeout = setTimeout(function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (_this2.props.onItemClick) {
...
&nbsp;
    return data.map(function (item) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (expandTrigger === 'hover') {
...
&nbsp;
      if (item.value === key) {
        if (groupIndex === 0) {
          ...
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (_this3.descArr) {
<span class="cstat-no" title="statement not covered" >            _this3.descArr = [];</span>
          }
        } else {
          _this3.displayData[groupIndex] = item.label;
          if (item.description) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!_this3.descArr) {
<span class="cstat-no" title="statement not covered" >              _this3.descArr = [];</span>
            }
...
&nbsp;
      return _react2['default'].createElement(
        ...
        renderCustomItem ? <span class="branch-0 cbranch-no" title="branch not covered" >renderCustomItem(item) </span>: item.label
      );
    });
  };
&nbsp;
  CascadeSubmenu.prototype.renderLoading = <span class="fstat-no" title="function not covered" >function renderLoading() {</span>
<span class="cstat-no" title="statement not covered" >    return _react2['default'].createElement('div', { className: 'kuma-loading-s ' + this.prefixCls('center-loading') });</span>
  };
&nbsp;
    ...
    value.forEach(function (key, index) {
      ...
      if (renderArr || loading[key]) {
        submenu.push(_react2['default'].createElement(
          ...
          {
            key: key,
            className: (0, _classnames4['default'])(_defineProperty({}, _this4.prefixCls('hoverable'), expandTrigger === 'hover' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >index &lt; cascadeSize - 1)</span>),
            style: style
          },
          loading[key] ? <span class="branch-0 cbranch-no" title="branch not covered" >_this4.renderLoading() </span>: _this4.renderUlList(renderArr, value[index + 1], index + 1)
        ));
      }
    });
    return submenu;
...
&nbsp;
  CascadeSubmenu.prototype.renderBottomBar = function renderBottomBar() {
    ...
    var btnSize = size === 'large' ? 'medium' : <span class="branch-1 cbranch-no" title="branch not covered" >'small';</span>
    return _react2['default'].createElement(
      'div',
...
&nbsp;
  CascadeSubmenu.prototype.renderItemDescription = function renderItemDescription() {
    ...
    if (this.descArr &amp;&amp; this.props.value &amp;&amp; this.props.value.length) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (desc) {
        return _react2['default'].createElement(
          'div',
          { className: this.prefixCls('item-description-wrap') },
          label,
          ': ',
          desc || <span class="branch-1 cbranch-no" title="branch not covered" >_i18n2['default'][this.props.locale].noDesc</span>
        );
      }
    }
    return null;
...
&nbsp;
  CascadeSubmenu.prototype.render = function render() {
    ...
    var submenuStyle = {};
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.props.cascaderHeight) {
<span class="cstat-no" title="statement not covered" >      submenuStyle.height = this.props.cascaderHeight;</span>
    }
    return _react2['default'].createElement(
      'div',
...
CascadeSubmenu.defaultProps = {
  ...
  onItemClick: <span class="fstat-no" title="function not covered" >function onItemClick() {</span>},
&nbsp;
  value: [],
  options: [],
  miniMode: true,
  onOkButtonClick: <span class="fstat-no" title="function not covered" >function onOkButtonClick() {</span>},
  size: 'large',
  className: '',
  locale: 'zh-cn',
  expandTrigger: 'click',
