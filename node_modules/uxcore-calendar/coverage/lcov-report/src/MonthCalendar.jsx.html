...
<html lang="en">
<head>
    <title>Code coverage report for src/MonthCalendar.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> MonthCalendar.jsx
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>34/60</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  MonthCalendar.prototype.getTriggerNode = <span class="fstat-no" title="function not covered" >function getTriggerNode() {</span>
...
&nbsp;
  MonthCalendar.prototype.clearValue = <span class="fstat-no" title="function not covered" >function clearValue(e) {</span>
<span class="cstat-no" title="statement not covered" >    e.stopPropagation();</span>
<span class="cstat-no" title="statement not covered" >    this.props.onSelect(null, null);</span>
  };
&nbsp;
...
&nbsp;
  MonthCalendar.prototype.handleChange = <span class="fstat-no" title="function not covered" >function handleChange(v) {</span>
<span class="cstat-no" title="statement not covered" >    var p = this.props;</span>
...
<span class="cstat-no" title="statement not covered" >      this.props.onSelect(new Date(date), v.format(p.format));</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.props.onSelect(v, v);</span>
    }
  };
&nbsp;
...
&nbsp;
    if (p.value) {
      ...
      calendarOptions.value = p.defaultOpenValue ? <span class="branch-0 cbranch-no" title="branch not covered" >this.getDate(p.defaultOpenValue) </span>: null;
    }
&nbsp;
    if (p.defaultValue) {
...
&nbsp;
        var showClear = p.allowClear ? value &amp;&amp; !p.disabled : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
        var newValue = value;
        if (newValue) {
        ...
        return _react2['default'].createElement(
          ...
          p.hasTrigger ? _react2['default'].createElement(_uxcoreIcon2['default'], { usei: true, name: 'riqi', className: 'kuma-calendar-trigger-icon ' + (showClear ? 'kuma-calendar-trigger-icon__has-clear' : '') }) : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
