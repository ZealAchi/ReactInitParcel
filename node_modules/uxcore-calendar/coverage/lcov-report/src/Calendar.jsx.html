...
<html lang="en">
<head>
    <title>Code coverage report for src/Calendar.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Calendar.jsx
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>53/87</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>118/137</span>
      </div>
    </div>
  </div>
...
&nbsp;
  Calendar.prototype.getTriggerNode = <span class="fstat-no" title="function not covered" >function getTriggerNode() {</span>
<span class="cstat-no" title="statement not covered" >    return this.trigger;</span>
  };
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (timezone) {
<span class="cstat-no" title="statement not covered" >      return value.utcOffset(parseInt(timezone, 10) * 60);</span>
    }
    return value;
  };
&nbsp;
...
&nbsp;
    ...
    var isAm = timePicker &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof timePicker.type === 'function' </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >timePicker.type.displayName === 'Pmam';</span>
    var key = 'day';
    <span class="missing-if-branch" title="if path not taken" >I</span>if (showTime) {
<span class="cstat-no" title="statement not covered" >      if (isAm) {</span>
<span class="cstat-no" title="statement not covered" >        key = 'am';</span>
      } else {
<span class="cstat-no" title="statement not covered" >        key = 'time';</span>
      }
    }
    return defaultFormatMap[locale][key];
  };
&nbsp;
  Calendar.prototype.clearValue = <span class="fstat-no" title="function not covered" >function clearValue(e) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    onSelect(null, null);</span>
  };
&nbsp;
...
&nbsp;
  Calendar.prototype.handleChange = <span class="fstat-no" title="function not covered" >function handleChange(v) {</span>
<span class="cstat-no" title="statement not covered" >    var onSelect = this.props.onSelect;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (v) {</span>
<span class="cstat-no" title="statement not covered" >      var date = v.valueOf();</span>
<span class="cstat-no" title="statement not covered" >      onSelect(new Date(date), v.format(generalizeFormat(this.getFormat())));</span>
    } else {
<span class="cstat-no" title="statement not covered" >      onSelect(v, v);</span>
    }
  };
&nbsp;
...
&nbsp;
      ...
      disabledTime: <span class="fstat-no" title="function not covered" >function disabledTime(current) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof p.disabledTime === 'function' &amp;&amp; current) {</span>
<span class="cstat-no" title="statement not covered" >          var date = current.clone();</span>
<span class="cstat-no" title="statement not covered" >          date.getTime = current.valueOf;</span>
<span class="cstat-no" title="statement not covered" >          return p.disabledTime(date);</span>
        }
<span class="cstat-no" title="statement not covered" >        return false;</span>
      ...
      timePicker: p.timePicker || (p.showTime ? <span class="branch-0 cbranch-no" title="branch not covered" >me.TimePickerElement </span>: null),
...
&nbsp;
    if (p.value) {
      ...
      calendarOptions.defaultValue = p.defaultOpenValue ? <span class="branch-0 cbranch-no" title="branch not covered" >this.getDate(p.defaultOpenValue) </span>: null;
    }
    if (p.defaultValue) {
      ...
      var _value2 = this.getDate(p.defaultOpenValue || new Date().getTime());
...
&nbsp;
    var triggerStyle = {};
    <span class="missing-if-branch" title="if path not taken" >I</span>if (p.inputWidth) {
<span class="cstat-no" title="statement not covered" >      triggerStyle.width = p.inputWidth;</span>
    }
&nbsp;
...
&nbsp;
    return _react2['default'].createElement(
      _Picker2['default'],
      _extends({ calendar: calendar, onChange: me.handleChange }, pickerOptions),
      function (_ref) {
...
Calendar.propTypes = {
  ...
  timePicker: _propTypes2['default'].node,
