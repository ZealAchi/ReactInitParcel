...
<html lang="en">
<head>
    <title>Code coverage report for src/fullTime/TimeTHead.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/fullTime/</a> TimeTHead.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  DateTHead.prototype.getPanelDays = function getPanelDays() {
    var days = [];
    var _props = this.props,
        value = _props.value,
        dataCount = _props.dataCount;
&nbsp;
    var currentDay = null;
    currentDay = value || <span class="branch-1 cbranch-no" title="branch not covered" >(0, _moment2['default'])();</span>
    for (var i = 0; i &lt; dataCount + 1; i++) {
      if (i === 0) {
        days.push('');
      } else {
        days.push(currentDay.date());
        currentDay = (0, _moment2['default'])(currentDay).add(1, 'days');
      }
    }
    return days;
  };
&nbsp;
  DateTHead.prototype.render = function render() {
    var _props2 = this.props,
        ...
        dataCount = _props2.dataCount;
&nbsp;
    var now = (0, _moment2['default'])();
    var current = value || <span class="branch-1 cbranch-no" title="branch not covered" >now;</span>
    var localeData = current.localeData();
    var weekDays = [];
    var panelDays = this.getPanelDays();
&nbsp;
    for (var dateColIndex = 0; dateColIndex &lt; dataCount + 1; dateColIndex++) {
      if (dateColIndex === 0) {
        ...
        current = (0, _moment2['default'])(current).add(1, 'days');
      }
    }
&nbsp;
