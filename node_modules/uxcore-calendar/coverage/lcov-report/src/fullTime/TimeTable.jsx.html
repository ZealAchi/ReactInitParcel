...
<html lang="en">
<head>
    <title>Code coverage report for src/fullTime/TimeTable.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/fullTime/</a> TimeTable.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    _this.getTimeLine = _this.getTimeLine.bind(_this);
    _this.state = {
      slicePiece: 0
    };
    return _this;
...
&nbsp;
  TimeTable.prototype.getTimeLine = function getTimeLine() {
    var _props = this.props,
        startHour = _props.startHour,
        step = _props.step,
        endHour = _props.endHour;
&nbsp;
    startHour = startHour ? parseInt(startHour, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >9;</span>
    endHour = endHour ? parseInt(endHour, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >23;</span>
    step = step ? parseInt(step, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >60;</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (endHour &lt; startHour) {
<span class="cstat-no" title="statement not covered" >      endHour = startHour;</span>
    }
...
&nbsp;
    var renderOpts = {
      startHour: startHour, step: step, endHour: endHour, type: type, slicePiece: slicePiece, current: value
    };
    <span class="missing-if-branch" title="if path not taken" >I</span>if (scheduleRender) {
<span class="cstat-no" title="statement not covered" >      var content = scheduleRender(renderOpts);</span>
...
&nbsp;
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'table',
        { className: tableCls, cellSpacing: '0', role: 'grid' },
