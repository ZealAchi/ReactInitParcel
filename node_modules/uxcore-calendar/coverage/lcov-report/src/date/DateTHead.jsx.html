...
<html lang="en">
<head>
    <title>Code coverage report for src/date/DateTHead.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/date/</a> DateTHead.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (props.showWeekNumber) {
<span class="cstat-no" title="statement not covered" >      showWeekNumberEl = _react2['default'].createElement(</span>
        'th',
        {
          role: 'columnheader',
