...
<html lang="en">
<head>
    <title>Code coverage report for src/CascadeMultiModal.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> CascadeMultiModal.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.5% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>132/160</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>124/136</span>
      </div>
    </div>
  </div>
...
&nbsp;
  CascadeMultiModal.prototype.onCancel = <span class="fstat-no" title="function not covered" >function onCancel() {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _data = this.data,</span>
        value = _data.value,
...
<span class="cstat-no" title="statement not covered" >      _this2.props.onCancel();</span>
    });
  };
&nbsp;
...
&nbsp;
  CascadeMultiModal.prototype.onExpand = <span class="fstat-no" title="function not covered" >function onExpand(expand) {</span>
<span class="cstat-no" title="statement not covered" >    this.setState({</span>
      expand: expand
    });
  };
...
<span class="cstat-no" title="statement not covered" >          _this4.onOk();</span>
        },
        onCancel: <span class="fstat-no" title="function not covered" >function onCancel() {</span>
<span class="cstat-no" title="statement not covered" >          _this4.onCancel();</span>
        }
      },
      this.renderContent()
    );
...
&nbsp;
    ...
    var arr = null;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (expand) {
...
<span class="cstat-no" title="statement not covered" >            _this6.onExpand(false);</span>
          }
        },
        (0, _locale2['default'])(locale).close
      );
    } else {
<span class="cstat-no" title="statement not covered" >      arr = _react2['default'].createElement(</span>
        'span',
        {
          className: prefixCls + '-model-expand',
          onClick: <span class="fstat-no" title="function not covered" >function onClick() {</span>
<span class="cstat-no" title="statement not covered" >            _this6.onExpand(true);</span>
          }
        },
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!labelList) {
...
<span class="cstat-no" title="statement not covered" >      style.maxHeight = 76;</span>
    }
