...
var toBytes = function (s) { return Array.from(s).map(function (c) { return c.charCodeAt(0); }); };
    ...
    if (check([0x1a, 0x45, 0xdf, 0xa3])) {
        ...
        if (idPos !== -1) {
            ...
            var findDocType = function (type) {
                return Array.from(type).every(function (c, i) { return sliced_1[docTypePos_1 + i] === c.charCodeAt(0); });
            };
