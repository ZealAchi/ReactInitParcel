 ...
 */
export declare function set<ChildBuilders extends Record<string, Builder>, Builder extends BasicBuilder<any, Model>, Model extends BasicModel<any>>(childBuilders: ChildBuilders): FieldSetBuilder<ChildBuilders>;
/**
 * 创建一个 `Form` builder，是最顶层的 builder 对象
 * @param childBuilders `Form` 每个字段对应的 builder 对象，其值可以是 `field`、`array` 或者 `set` 的返回值
 */
export declare function form<ChildBuilders extends Record<string, Builder>, Builder extends BasicBuilder<any, Model>, Model extends BasicModel<any>>(childBuilders: ChildBuilders): FormBuilder<ChildBuilders, Builder, Model>;
