 ...
 */
export declare function useForm<T extends Record<string, Builder>, Builder extends BasicBuilder<unknown, Model>, Model extends BasicModel<unknown>>(arg: FormStrategy.View | FormBuilder<T, Builder, Model>): IForm<$FieldSetBuilderChildren<T>>;
